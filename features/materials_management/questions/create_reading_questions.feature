Feature: Create Reading Questions
	...
	Scenario: Create Single Paragraph Reading questions with valid attributes
		...
		And I fill in "Content # 1" with "A is A"
		And I fill in "Content # 2" with "B is B"
		And I fill in "Content # 3" with "C is C"
		And I fill in "Content # 4" with "D is D"
		And I fill in "Content # 5" with "E is E"
